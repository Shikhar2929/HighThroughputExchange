...
class SeqControllerTest {
    ...
    void getUpdates_success_returnsMetadataAndUpdates() throws Exception {
        ...
        OrderbookUpdate u12 =
                new OrderbookUpdate(12L, List.of(new PriceChange("ABC", 100, 7, Side.BID)));
        when(orderbookSeqLog.get(from)).thenReturn(List.of(u11, u12));

        mockMvc.perform(get("/updates").param("fromExclusive", String.valueOf(from)))
                .andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.updates[0].seq").value(11))
                .andExpect(jsonPath("$.updates[1].seq").value(12))
    ...
    void getUpdates_minSeqUnavailable_returnsGone() throws Exception {
        ...
        mockMvc.perform(get("/updates").param("fromExclusive", "10"))
    ...
    void getUpdates_fromTooOld_returnsGone() throws Exception {
        ...
        mockMvc.perform(get("/updates").param("fromExclusive", "0"))
                .andExpect(status().isGone())
